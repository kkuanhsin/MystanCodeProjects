...
def main():
	"""
	You will draw Sierpinski Triangle in different order
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order: Sierpinski Triangle's order
	:param length:length of the triangle
	:param upper_left_x:the point of x
	:param upper_left_y:the point of y
	"""
	if order != 0:
